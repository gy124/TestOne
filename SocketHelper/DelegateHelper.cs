...
namespace SocketHelper
{
    ...
    public class DelegateHelper
    {
        ...
        /// 客户端返回状态信息委托方法
        /// </summary>
        public static SocketStationCallBack TcpClientStateInfo;
        #endregion
        ...
        /// 服务端返回状态信息委托方法
        /// </summary>
        public static SocketStationCallBack TcpServerStateInfo;
        /// <summary>
        /// 添加和删除客户端
        /// </summary>
        ...
        /// </summary>
        /// <param name="msg"></param>
        public delegate void SocketStationCallBack(string msg,EnumClass.SocketState state);
        /// <summary>
        /// 添加/删除下线的客户端委托
        /// </summary>
        /// <param name="socket"></param>
        ...
        public static void BaseVoid(string str,EnumClass.SocketState state)
        {
        }
        #endregion
    }
