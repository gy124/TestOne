...
public partial class CTabControl : TabControl
{
    ...
    private void PaintTabText(System.Drawing.Graphics graph, int index)
    {
        ...
        Rectangle rect2 = new Rectangle(rect.Left, rect.Top+3, rect.Width, rect.Height-3);
        ...
        else
        {
            ...
            {
                Brush brush = new SolidBrush(Color.FromArgb(217, 225, 232));
                forebrush = brush;//SystemBrushes.ControlText
            }
            else
            {
                Brush brush = new SolidBrush(Color.FromArgb(40, 44, 55));
                forebrush = brush;//SystemBrushes.ControlLightLight
            }
        }
