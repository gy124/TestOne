...
namespace MotionCtrl
{
    ...
    public class SYS_SET
    {
        ...
        public bool isDemoMode { get { return ((mode & EM_SYS_MODE.DEMO) == EM_SYS_MODE.DEMO); } }//无料空跑演示模式
        ...
        public bool isNormalMode { get { return ((mode & EM_SYS_MODE.NORMAL) == EM_SYS_MODE.NORMAL); } }//正常模式

        public bool isStandby { get { return (status == EM_SYS_STA.STANDBY); } }//就绪可以开始状态
        ...
        public void SaveSysCfg(string filename = "")
        {
            ...
            inf.WriteInteger("PRODUCT_SET", "box_tray_cnt", box_tray_cnt);   //料箱数量  
            //信息处理
